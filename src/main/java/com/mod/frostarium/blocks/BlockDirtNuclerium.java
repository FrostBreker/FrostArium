...
public class BlockDirtNuclerium extends BlockDirt
{
    ...
    public BlockDirtNuclerium(Material ground)
    {
        super(ground);
    ...
    public IIcon getIcon(IBlockAccess p_149673_1_, int p_149673_2_, int p_149673_3_, int p_149673_4_, int p_149673_5_)
    {
        ...
        if (i1 == 2)
        {
            ...
            if (p_149673_5_ != 0)
            {
                ...
                {
                    return BlockMod.block_nuclerium_grass.getIcon(p_149673_1_, p_149673_2_, p_149673_3_, p_149673_4_, p_149673_5_);
                }

                Block block = p_149673_1_.getBlock(p_149673_2_, p_149673_3_ + 1, p_149673_4_);

                if (block != BlockMod.block_nuclerium_dirt && block != Blocks.grass)
                {
                    return this.field_150010_M;
                }
            }
    ...
    public boolean canSustainPlant(IBlockAccess world, int x, int y, int z, ForgeDirection direction, IPlantable plantable)
    {
        ...
        switch (plantType)
        {
            ...
            case Plains: return this == BlockMod.block_nuclerium_dirt || this == Blocks.dirt || this == Blocks.farmland;
