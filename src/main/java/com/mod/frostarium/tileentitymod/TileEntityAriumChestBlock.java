package com.mod.frostarium.tileentitymod;
...
public class TileEntityAriumChestBlock extends TileEntity implements IInventory
{
    ...
    {
        return this.hasCustomInventoryName() ? this.customName : "container.AriumChest";
    }
         ...
         //   this.numUsingPlayers = 0;
          ...
          //  while(iterator.hasNext())
            ...
            //    EntityPlayer entityplayer = (EntityPlayer)iterator.next();
              ...
              //  if(entityplayer.openContainer instanceof ContainerAriumChest)
                {
